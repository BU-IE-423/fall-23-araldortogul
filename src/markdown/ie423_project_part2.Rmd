...
-   Our markdown document can be found [here](https://bu-ie-423.github.io/fall-23-araldortogul/src/markdown/ie423_project_part2.Rmd) (.Rmd file).
-   The data used in this study can be found [here](https://bu-ie-423.github.io/fall-23-araldortogul/src/data/part2_data.zip) (.zip file)
...
long_data %>%
  ...
  labs(title = "The Given Stock Data")
